            ...
            <div id="tree-wrap">
                ...
                <?php foreach($data['all_menu'] as $menu):?>
                    <ul class="topnav menu-left-nest">
                        ...
                        <?php foreach($menu['child'] as $child_meun):?>
                        <li>
                            <a class="tooltip-tip ajax-load" href="#" title="Blog App">
                                <i class="icon-document-edit"></i>
                                <span><?php echo $child_meun['menu_name'];?></span>

                            </a>
                            <ul>
                            <?php if(!empty($child_meun['child']) && is_array($child_meun['child'])):?>
                            <?php foreach($child_meun['child'] as $last_menu):?>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="blog-list.html" title="Blog List"><i class="entypo-doc-text"></i><span><?php echo $last_menu['menu_name'];?></span></a>
                                </li>
                            <?php endforeach;?>
                            <?php endif;?>
                            </ul>
