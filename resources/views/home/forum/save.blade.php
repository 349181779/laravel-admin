...
@include('home.block.base_header')
    <script>
        $(function(){
            $('select[name=forum_cat_id]').val(<?php echo $data->forum_cat_id;?>);
        })
    </script>
@show
</head>
                ...
                <div class="index-box">
                    ...
                    <div class="c_q_cont container-fluid" style="display:block;">
                        ...
                        <div style="margin: 50px 0;">
                            <form class="form-horizontal bucket-form ajax-form" action="<?php echo action('User\ForumController@postSave') ;?>" method="post">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><strong>标题：</strong></label>
                                    <div class="col-sm-3">
                                        <input type="text" name="title" value="<?php echo $data->title ;?>" class="form-control" datatype="*" errormsg="" >
